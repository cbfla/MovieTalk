...
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">수정페이지</div>
			<!-- /.panel-heading -->
			<div class="panel-body">
				...
				<input type="hidden" name="keyword" value="${cri.keyword}">
					...
					<div class="form-group">
						...
						<textarea rows="3" cols="" name="content" class="form-control">${board.content}</textarea>
					</div>
...
<!-- 버튼클릭해도 화면 넘어가지 말라고 프리벤트~ 아래 위 데이타오퍼안의 값 가져옴-->
